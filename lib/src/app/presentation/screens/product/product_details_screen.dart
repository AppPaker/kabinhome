...
import 'package:app/src/app/presentation/components/image_slider.dart';
import 'package:app/src/app/presentation/routes/routes_navigator.dart';
import 'package:app/src/app/presentation/screens/cart/cart_screen.dart';
import 'package:app/src/app/presentation/screens/order/temporary_screen.dart';
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: CustomButton(
                          onPressed: () {
                            RouteNavigator.route(context, const TemporaryDetailScreen());
                          },
                    ...
                    SizedBox(
                      ...
                      child: CustomButton(
                          ...
                          onPressed: () {
                            RouteNavigator.route(context, const CartScreen());
                          },
                          showLoadingIndicator: true,
                          text: "Add to cart"),
                    ),
